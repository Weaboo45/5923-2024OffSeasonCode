...
public class SwerveDrivetrain extends SubsystemBase {
  ...
  private SlewRateLimiter m_magLimiter = new SlewRateLimiter(1.8); // % per second (1 = 100%)
  private SlewRateLimiter m_rotLimiter = new SlewRateLimiter(2.0); // % per second (1 = 100%)
  ...
  public SwerveDrivetrain() {
    ...
    AutoBuilder.configureHolonomic(
            ...
            this::driveChass, // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
            new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
                    new PIDConstants(5.0, 0.0, 0.0), // Translation PID constants
                    new PIDConstants(5.0, 0.0, 0.0), // Rotation PID constants
                    4.0, // Max module speed, in m/s
                    Constants.CENTER_TO_WHEEL_X, // Drive base radius in meters. Distance from robot center to furthest module.
  ...
  /**
     ...
     */
    public void driveChass(ChassisSpeeds speeds) {
      SwerveModuleState[] swerveModuleStates = Constants.DRIVE_KIN.toSwerveModuleStates(speeds);
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    if (rateLimit) {
      ...
      if (m_currentTranslationMag != 0.0) {
        directionSlewRate = Math.abs(1.2 / m_currentTranslationMag);  //1.2 can be changed it is rads / second
      } else {
    ...
    double xSpeedDelivered = xSpeedCommanded * Constants.DRIVETRAIN_MAX_SPEED;
    double ySpeedDelivered = ySpeedCommanded * Constants.DRIVETRAIN_MAX_SPEED;
    double rotDelivered = m_currentRotation * Constants.DRIVETRAIN_MAX_TURN_SPEED;
